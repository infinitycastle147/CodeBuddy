...
@router.get("/health", summary="Health Check", description="Check if the user router is healthy and responding.")
def health_check():
    """
...
async def create_user(
    ...
    try:
        ...
        new_user = UserResponse(**new_user)
...
async def get_user_by_email(
    email: EmailStr = Path(..., description="The email address of the user to retrieve"),
    user_repo: UserRepository = Depends(get_user_repository)
):
    """
