...
export default function SetupPage() {
    ...
    const steps = [
        { title: "Welcome", icon: Sparkles, color: "from-violet-500 to-purple-600" },
        ...
        { title: "Complete", icon: CheckCircle, color: "from-green-500 to-emerald-600" },
    ]
    ...
    const updateSetupData = (section: keyof SetupData, field: string, value: string) => {
        setSetupData((prev) => ({
            ...prev,
            [section]: {
                ...prev[section],
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 translate-y-12 -translate-x-12 blur-3xl opacity-70">
                <div className="w-72 h-72 bg-gradient-to-br from-emerald-400 to-blue-600 rounded-full" />
            </div> */}
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Let's configure your workspace in a few simple steps to get you started with all the tools you need.
                    </p>
                </div>
                        ...
                        <div className="p-8 lg:p-12">
                                ...
                                <div className="text-center space-y-8 max-w-2xl mx-auto">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-lg text-gray-600 leading-relaxed">
                                            We'll help you connect your favorite tools and configure everything you need. The entire process
                                    ...
                                    <Alert className="border-blue-200 bg-blue-50/50 backdrop-blur-sm">
                                        ...
                                        <AlertDescription className="text-blue-800">
                                            <strong className="font-semibold">Your privacy matters.</strong> All your API keys and sensitive
                                            information are stored securely in your browser only. We never access, store, or transmit your
                                            personal credentials to our servers. Your data stays with you, always.
                                        </AlertDescription>
                                    </Alert>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                                        <div className="text-center p-4 rounded-xl bg-gray-50/50">
                                            ...
                                            <p className="text-xs text-gray-600">Connect repositories</p>
                                        </div>
                                        <div className="text-center p-4 rounded-xl bg-gray-50/50">
                                    ...
                                    <div className="text-center space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">
                                                Connect your GitHub account to access repositories and manage your codebase seamlessly.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-6">
                                        <div className="space-y-3">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => updateSetupData("github", "username", e.target.value)}
                                                className="h-12 text-base border-gray-200 focus:border-gray-400 focus:ring-gray-400"
                                            />
                                        </div>

                                        <div className="space-y-3">
                                            <Label htmlFor="github-token" className="text-sm font-semibold text-gray-700">
                                            ...
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    onChange={(e) => updateSetupData("github", "token", e.target.value)}
                                            ...
                                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                                <p className="text-sm text-blue-800">
                                                    <strong>Need a token?</strong> Go to GitHub Settings → Developer settings → Personal access
                                                    tokens → Generate new token. Select 'repo' scope for full repository access.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {currentStep === 2 && (
                                <div className="space-y-8 max-w-3xl mx-auto">
                                    <div className="text-center space-y-4">
                                        ...
                                        <div>
                                            <div className="flex items-center justify-center space-x-3 mb-2">
                                                <h2 className="text-2xl font-bold text-gray-900">Connect Jira</h2>
                                                <Badge variant="secondary" className="bg-gray-100 text-gray-700">
                                                    Optional
                                                </Badge>
                                            </div>
                                            <p className="text-gray-600">
                                                Link your Jira workspace to streamline project management and issue tracking.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        <div className="space-y-3">
                                            <Label htmlFor="jira-url" className="text-sm font-semibold text-gray-700">
                                                Jira Instance URL
                                            </Label>
                                            <Input
                                                id="jira-url"
                                                ...
                                                onChange={(e) => updateSetupData("jira", "url", e.target.value)}
                                                className="h-12 text-base border-gray-200 focus:border-blue-400 focus:ring-blue-400"
                                            />
                                        </div>

                                        <div className="space-y-3">
                                            <Label htmlFor="jira-username" className="text-sm font-semibold text-gray-700">
                                                Email Address
                                            </Label>
                                            <Input
                                                id="jira-username"
                                                ...
                                                onChange={(e) => updateSetupData("jira", "username", e.target.value)}
                                                className="h-12 text-base border-gray-200 focus:border-blue-400 focus:ring-blue-400"
                                            />
                                        </div>

                                        <div className="space-y-3">
                                            <Label htmlFor="jira-token" className="text-sm font-semibold text-gray-700">
                                                API Token
                                            </Label>
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    onChange={(e) => updateSetupData("jira", "apiToken", e.target.value)}
                                                ...
                                                >
                                                    {showTokens.jira ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                                                </Button>
                                            </div>
                                        </div>

                                        <div className="space-y-3">
                                            <Label htmlFor="jira-project" className="text-sm font-semibold text-gray-700">
                                                Project Key
                                            </Label>
                                            <Input
                                                id="jira-project"
                                                ...
                                                onChange={(e) => updateSetupData("jira", "projectKey", e.target.value)}
                                                className="h-12 text-base border-gray-200 focus:border-blue-400 focus:ring-blue-400"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                        <p className="text-sm text-blue-800">
                                            <strong>How to get your API token:</strong> Go to Jira Settings → Personal Access Tokens → Create
                                            token, or use Account Settings → Security → API tokens for Atlassian Cloud.
                                        </p>
                                    </div>
                                </div>
                            )}
                            ...
                            {currentStep === 3 && (
                                <div className="space-y-8 max-w-2xl mx-auto">
                                    <div className="text-center space-y-4">
                                        ...
                                        <div>
                                            <div className="flex items-center justify-center space-x-3 mb-2">
                                                <h2 className="text-2xl font-bold text-gray-900">AI Model Setup</h2>
                                                <Badge variant="secondary" className="bg-gray-100 text-gray-700">
                                                    Optional
                                                </Badge>
                                            </div>
                                            <p className="text-gray-600">
                                                Use your own AI model to unlock free access to all premium features.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <Alert className="border-emerald-200 bg-emerald-50/50 backdrop-blur-sm">
                                        ...
                                        <AlertDescription className="text-emerald-800">
                                            <strong className="font-semibold">Unlock free premium access!</strong> By providing your own AI
                                            model credentials, you can use all our advanced features at no cost. We'll use your AI model for
                                            processing, and your API key remains secure in your browser.
                                        </AlertDescription>
                                    </Alert>

                                    <div className="space-y-6">
                                        <div className="space-y-3">
                                            <Label htmlFor="ai-model-name" className="text-sm font-semibold text-gray-700">
                                                AI Model Name
                                            </Label>
                                            <Input
                                                id="ai-model-name"
                                                ...
                                                onChange={(e) => updateSetupData("aiModel", "name", e.target.value)}
                                                className="h-12 text-base border-gray-200 focus:border-emerald-400 focus:ring-emerald-400"
                                            />
                                        </div>

                                        <div className="space-y-3">
                                            <Label htmlFor="ai-model-token" className="text-sm font-semibold text-gray-700">
                                                API Token
                                            </Label>
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    onChange={(e) => updateSetupData("aiModel", "token", e.target.value)}
                                    ...
                                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                        <p className="text-sm text-gray-700">
                                            <strong>Supported providers:</strong> OpenAI (GPT-4, GPT-3.5), Anthropic (Claude), Google AI
                            ...
                            {currentStep === 4 && (
                                <div className="text-center space-y-8 max-w-2xl mx-auto">
                                    ...
                                    <div className="space-y-4">
                                        <h2 className="text-3xl font-bold text-gray-900">Perfect! You're All Set</h2>
                                        <p className="text-lg text-gray-600 leading-relaxed">
                                            Your workspace is now configured and ready to use. Let's start building something amazing
                                            together!
                                        </p>
                                    </div>

                                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
                                        <h3 className="font-semibold text-gray-900 mb-4 text-left">Configuration Summary</h3>
                                        <div className="space-y-3">
                                            <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100">
                                                ...
                                                <Badge
                                                    ...
                                                    className={isGitHubValid ? "bg-green-100 text-green-800 border-green-200" : ""}
                                                >
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100">
                                                ...
                                                <Badge
                                                    ...
                                                    className={setupData.jira.url ? "bg-blue-100 text-blue-800 border-blue-200" : ""}
                                                >
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100">
                                                ...
                                                <Badge
                                                    variant={setupData.aiModel.name ? "default" : "secondary"}
                                                    className={setupData.aiModel.name ? "bg-emerald-100 text-emerald-800 border-emerald-200" : ""}
                                                >
